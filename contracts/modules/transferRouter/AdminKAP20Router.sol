...
import "../authorization/Authorization.sol";
import "../kyc/interfaces/IKYC.sol";
import "../KAP20/interfaces/IKKUB.sol";
import "../KAP20/interfaces/IKToken.sol";
import "../KAP20/interfaces/IKAP20.sol";
...
contract AdminKAP20Router is Authorization, IAdminKAP20Router {
  ...
  modifier onlyAllowedAddress() {
    require(
      ...
      "Restricted only allowed address"
    );
    _;
  }
